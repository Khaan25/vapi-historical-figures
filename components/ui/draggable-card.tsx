...
import { animate, motion, useAnimationControls, useMotionValue, useSpring, useTransform, useVelocity } from 'motion/react'
...
export const DraggableCardBody = ({ className, children }: { className?: string; children?: React.ReactNode }) => {
  ...
  return (
    <motion.div
      ...
      className={cn('relative min-h-96 w-80 overflow-hidden rounded-md bg-neutral-100 p-6 shadow-2xl transform-3d dark:bg-neutral-900', className)}
    >
      {children}
      <motion.div
        style={{
