...
export function FormMessage({ message }: { message: Message }) {
  ...
  return (
    <>
      {'success' in messageValue && (
        <div className="text-center text-success border border-success/50 rounded-md py-2 px-4">
      ...
      {'message' in messageValue && (
        <div className="text-center border border-foreground/50 rounded-md py-2 px-4">
